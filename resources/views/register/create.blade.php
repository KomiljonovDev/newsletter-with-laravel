        ...
        <div class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
            ...
            <form method="POST" action="/register" class="mt-10">
                ...
                <div class="mb-6">
                    ...
                    <label class="block mb-2 uppercase font-bold text-cs text-gray-700" for="username">
                        Username
                    </label>
                    ...
                    @error('username')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                    <label class="block mb-2 uppercase font-bold text-cs text-gray-700" for="email">
                        Email
                    </label>
                    ...
                    @error('email')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                    <label class="block mb-2 uppercase font-bold text-cs text-gray-700" for="password">
                        Password
                    </label>
